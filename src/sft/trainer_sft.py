# Taken and modified from Open-Assistant's model/model_training/trainer_sft.py
...
import datasets
import torch
from model_training.custom_datasets.dialogue_collator import (
...
def argument_parsing(notebook=False, notebook_args=None):
    ...
    parser.add_argument("--wandb-entity", type=str, default="tlc4418")  # CHANGE THIS
    parser.add_argument(
